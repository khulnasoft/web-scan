...
import docs, { about, featureIntro, license, fairUse, supportUs } from 'web-scan-live/utils/docs';
    ...
    <AboutContainer>
      ...
      <Section>
        ...
        <SponsorshipContainer>
          <p>
            Web-Scan is kindly sponsored
            by <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=web-scan&utm_source=wcgh">
              Terminal Trove
            </a>
            <br />
            ...
            <br />
            <small>
              <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/newsletter?utm_campaign=github&utm_medium=referral&utm_content=web-scan&utm_source=wcgh">
                Find your next CLI / TUI tool, and get updates to your inbox
              </a>
            </small>
          </p>
          <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=web-scan&utm_source=wcgh">
            <img width="300" alt="Terminal Trove" src="https://i.ibb.co/T1KzVmR/terminal-trove-green.png" />
          </a>
        </SponsorshipContainer>
        <hr />
        <p>
          Web-Scan is developed and maintained by <a target="_blank" rel="noreferrer" href="https://khulnasoft.com">KhulnaSoft Ltd</a>.
          It's licensed under the <a target="_blank" rel="noreferrer" href="https://github.com/khulnasoft/web-scan/blob/master/LICENSE">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/khulnasoft/web-scan">GitHub</a>.
          If you've found this service useful, consider <a target="_blank" rel="noreferrer" href="https://github.com/sponsors/khulnasoft">sponsoring me</a> from $1/month,
      ...
      <Section>
        <p>Web-Scan is designed to be easily self-hosted.</p>
        <Heading as="h3" size="small" color={colors.primary}>Option #1 - Netlify</Heading>
        <p>Click the button below to deploy to Netlify</p>
        <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/khulnasoft/web-scan">
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/khulnasoft/web-scan#readme">github.com/khulnasoft/web-scan</a>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Configuring</Heading>
        <p>
          There are some optional environmental variables you can specify to give you access to some additional Web-Scans.
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a target="_blank" rel="noreferrer" href="https://github.com/khulnasoft/web-scan">Web-Scan</a> is distributed under the MIT license,
          © <a target="_blank" rel="noreferrer" href="https://khulnasoft.com">KhulnaSoft Ltd</a> { new Date().getFullYear()}
        </b>
        <br />
