      ...
      <AboutContainer>
        ...
        <Section>
          ...
          <SponsorshipContainer>
            <p>
              Web-Scan is kindly sponsored by{" "}
              <a
                target="_blank"
                rel="noreferrer"
          ...
          <hr />
          <p>
            Web-Scan is developed and maintained by{" "}
            <a target="_blank" rel="noreferrer" href="https://khulnasoft.com">
              KhulnaSoft Ltd
            </a>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/khulnasoft/web-scan/blob/master/LICENSE"
            >
              MIT license
            </a>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/sponsors/khulnasoft"
            >
              sponsoring me
            </a>{" "}
        ...
        <Section>
          ...
          <p>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://hub.docker.com/r/khulnasoft/web-scan"
            >
              DockerHub
            </a>
            <br />
          ...
          <pre>
            git clone https://github.com/khulnasoft/web-scan.git
            <br />
            cd web-scan # Move into the project directory
            <br />
          ...
          <p>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/khulnasoft/web-scan#readme"
            >
              github.com/khulnasoft/web-scan
            </a>
          </p>
          ...
          <p>
            ...
            give you access to some additional Web-Scans. See the README for
