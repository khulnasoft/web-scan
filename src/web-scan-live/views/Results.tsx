...
import Modal from 'web-scan-live/components/Form/Modal';
import Footer from 'web-scan-live/components/misc/Footer';
import Nav from 'web-scan-live/components/Form/Nav';
import type { RowProps }  from 'web-scan-live/components/Form/Row';

import Loader from 'web-scan-live/components/misc/Loader';
import ErrorBoundary from 'web-scan-live/components/misc/ErrorBoundary';
import SelfScanMsg from 'web-scan-live/components/misc/SelfScanMsg';
import DocContent from 'web-scan-live/components/misc/DocContent';
import ProgressBar, { type LoadingJob, type LoadingState, initialJobs } from 'web-scan-live/components/misc/ProgressBar';
import ActionButtons from 'web-scan-live/components/misc/ActionButtons';
import AdditionalResources from 'web-scan-live/components/misc/AdditionalResources';
import ViewRaw from 'web-scan-live/components/misc/ViewRaw';

import ServerLocationCard from 'web-scan-live/components/Results/ServerLocation';
import ServerInfoCard from 'web-scan-live/components/Results/ServerInfo';
import HostNamesCard from 'web-scan-live/components/Results/HostNames';
import WhoIsCard from 'web-scan-live/components/Results/WhoIs';
import LighthouseCard from 'web-scan-live/components/Results/Lighthouse';
import ScreenshotCard from 'web-scan-live/components/Results/Screenshot';
import SslCertCard from 'web-scan-live/components/Results/SslCert';
import HeadersCard from 'web-scan-live/components/Results/Headers';
import CookiesCard from 'web-scan-live/components/Results/Cookies';
import RobotsTxtCard from 'web-scan-live/components/Results/RobotsTxt';
import DnsRecordsCard from 'web-scan-live/components/Results/DnsRecords';
import RedirectsCard from 'web-scan-live/components/Results/Redirects';
import TxtRecordCard from 'web-scan-live/components/Results/TxtRecords';
import ServerStatusCard from 'web-scan-live/components/Results/ServerStatus';
import OpenPortsCard from 'web-scan-live/components/Results/OpenPorts';
import TraceRouteCard from 'web-scan-live/components/Results/TraceRoute';
import CarbonFootprintCard from 'web-scan-live/components/Results/CarbonFootprint';
import SiteFeaturesCard from 'web-scan-live/components/Results/SiteFeatures';
import DnsSecCard from 'web-scan-live/components/Results/DnsSec';
import HstsCard from 'web-scan-live/components/Results/Hsts';
import SitemapCard from 'web-scan-live/components/Results/Sitemap';
import DomainLookup from 'web-scan-live/components/Results/DomainLookup';
import DnsServerCard from 'web-scan-live/components/Results/DnsServer';
import TechStackCard from 'web-scan-live/components/Results/TechStack';
import SecurityTxtCard from 'web-scan-live/components/Results/SecurityTxt';
import ContentLinksCard from 'web-scan-live/components/Results/ContentLinks';
import SocialTagsCard from 'web-scan-live/components/Results/SocialTags';
import MailConfigCard from 'web-scan-live/components/Results/MailConfig';
import HttpSecurityCard from 'web-scan-live/components/Results/HttpSecurity';
import FirewallCard from 'web-scan-live/components/Results/Firewall';
import ArchivesCard from 'web-scan-live/components/Results/Archives';
import RankCard from 'web-scan-live/components/Results/Rank';
import BlockListsCard from 'web-scan-live/components/Results/BlockLists';
import ThreatsCard from 'web-scan-live/components/Results/Threats';
import TlsCipherSuitesCard from 'web-scan-live/components/Results/TlsCipherSuites';
import TlsIssueAnalysisCard from 'web-scan-live/components/Results/TlsIssueAnalysis';
import TlsClientSupportCard from 'web-scan-live/components/Results/TlsClientSupport';

import keys from 'web-scan-live/utils/get-keys';
import { determineAddressType, type AddressType } from 'web-scan-live/utils/address-type-checker';
import useMotherHook from 'web-scan-live/hooks/motherOfAllHooks';
import {
...
const Results = (props: { address?: string } ): JSX.Element => {
  ...
  return (
    <ResultsOuter>
      ...
      {/* { address?.includes(window?.location?.hostname || 'web-scan.netlify.app') && <SelfScanMsg />} */}
      ...
      <FilterButtons>{ showFilters ? <>
        ...
        <span className="toggle-filters" onClick={() => setShowFilters(false)}>Hide</span>
          ...
          <div className="control-options">
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/khulnasoft/web-scan"><span className="toggle-filters">View GitHub</span></a>
          </div>
      ) }
      </FilterButtons>
      <ResultsContent>
