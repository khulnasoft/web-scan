...
import Row, { Details } from "web-scan-live/components/Form/Row";
    ...
    >
      ...
      {securityTxt.isPresent && (
        <>
          ...
          <Row
            lbl="PGP Signed"
            val={securityTxt.isPgpSigned ? "✅ Yes" : "❌ No"}
          />
          {securityTxt.fields &&
            Object.keys(securityTxt.fields).map(
      ...
      {!securityTxt.isPresent && (
        <small>
          Having a security.txt ensures security researchers know how and where
