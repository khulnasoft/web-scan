...
import Row, {
  ExpandableRow,
  type RowProps,
} from "web-scan-live/components/Form/Row";
...
const makeAnswerList = (recordData: any): RowProps[] => {
  return [
    ...
    {
      lbl: "Type",
      val: `${getRecordTypeName(recordData.type)} (${recordData.type})`,
    },
            ...
            {record.isFound && record.answer && (
              <>
                ...
                {record.answer.map((answer: any, index: number) => {
                  ...
                  const label =
                    keyData.flags && keyData.flags !== "Unknown"
                      ? keyData.flags
                      : key;
                  return (
                    <ExpandableRow
