...
const resources = [
  ...
  },
  {
    ...
    description:
      "Checks a website against Zscaler's dynamic risk scoring engine",
...
const AdditionalResources = (props: { url?: string }): JSX.Element => {
  return (
    <Card heading="External Tools for Further Research" styles={CardStyles}>
      ...
      <Note>
        These tools are not affiliated with Web-Scan. Please use them at your
        own risk.
        <br />
        At the time of listing, all of the above were available and free to use
        - if this changes, please report it via GitHub (
        <a href="https://github.com/khulnasoft/web-scan">khulnasoft/web-scan</a>).
      </Note>
    </Card>
  );
};
