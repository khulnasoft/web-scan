    ...
    <HomeContainer>
        ...
        <div className="inner">
          <p>
            ...
            <span className="cta">
              ...
              the <a target="_blank" rel="noreferrer" className="cta" href="https://terminaltrove.com/newsletter?utm_campaign=github&utm_medium=referral&utm_content=web-scan&utm_source=wcgh">
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          ...
          <a href="/about#api-documentation" title="View the API documentation, to use Web-Scan programmatically">
